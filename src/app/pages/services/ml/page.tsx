...
export default function MLService() {
  ...
  const loadService = async () => {
    try {
      ...
      const mlService = servicios.find(s => s.categoria === 'ML');
      setService(mlService || null);
    } catch (error) {
      console.error("Error cargando servicio ML:", error);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="relative">
            {loading ? (
              ...
              <img
                src={service ? getImageUrl(service.url_portada) : "/services/lamborghini.svg"}
                alt={service?.nombre || "Mantenimiento de Laboratorio"}
