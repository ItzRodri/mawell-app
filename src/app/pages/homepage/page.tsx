        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Nuestra misión, visión y objetivo son la brújula que guía cada proyecto, 
              cada decisión y cada relación con nuestros clientes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 h-full">
                ...
                <p className="text-gray-700 leading-relaxed text-center">
                  Mantener una relación de confianza y fidelidad con nuestros clientes 
                  brindando soluciones integrales a precios competitivos, creciendo 
                  continuamente apoyados en personal capacitado y tecnología de vanguardia. 
                  Trabajamos siempre con calidad y creatividad guiados por los principios de Dios.
                </p>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 h-full">
                ...
                <p className="text-gray-700 leading-relaxed text-center">
                  ...
                  reconocimiento de la calidad de todos los servicios y productos 
                  que les brindamos.
                </p>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 h-full">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">OBJETIVO</h3>
                <div className="h-1 w-16 bg-gradient-to-r from-[#1E6B96] to-[#0E3855] mx-auto mb-6 rounded-full"></div>
                <p className="text-gray-700 leading-relaxed text-center">
                  Ayudar a nuestros clientes a obtener un rendimiento óptimo y los 
                  mejores resultados en sus equipos y procesos, traducidos en sistemas 
                  más eficientes que les permitan un ahorro significativo al momento 
                  de analizar los frutos de la inversión.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 flex justify-center">
            <div className="flex items-center gap-4">
              ...
              <div className="w-2 h-2 bg-[#2079AB] rounded-full animate-pulse" style={{animationDelay: '0.2s'}}></div>
              <div className="w-2 h-2 bg-[#1E6B96] rounded-full animate-pulse" style={{animationDelay: '0.4s'}}></div>
            </div>
          </div>
        </div>
      </section>
